...
type Chunks struct {
	...
	Chunk []float64 `protobuf:"fixed64,1,rep,packed,name=Chunk,proto3" json:"Chunk,omitempty"`
}
...
func (x *Chunks) GetChunk() []float64 {
	if x != nil {
		return x.Chunk
	}
	return nil
...
var file_sound_app_proto_rawDesc = []byte{
	...
	0x75, 0x6e, 0x6b, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x43, 0x68, 0x75, 0x6e, 0x6b, 0x18, 0x01, 0x20,
	0x03, 0x28, 0x01, 0x52, 0x05, 0x43, 0x68, 0x75, 0x6e, 0x6b, 0x22, 0x56, 0x0a, 0x08, 0x53, 0x6f,
...
var file_sound_app_proto_depIdxs = []int32{
	...
	2, // 2: SongData.info:type_name -> SongInfo
	5, // 3: SongData.chunks:type_name -> Chunks
	1, // 4: Player.GetAllSong:input_type -> SongRequest
	1, // 5: Player.PlaySong:input_type -> SongRequest
	3, // 6: Player.GetAllSong:output_type -> AllSong
	6, // 7: Player.PlaySong:output_type -> SongData
